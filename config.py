...
UPLOAD_MAX_FILE_MB_CSV = int(_get_env("UPLOAD_MAX_FILE_MB_CSV", "60"))
UPLOAD_MAX_FILE_MB_TSV = int(_get_env("UPLOAD_MAX_FILE_MB_TSV", str(UPLOAD_MAX_FILE_MB_CSV)))
UPLOAD_MAX_FILE_MB_XLSX = int(_get_env("UPLOAD_MAX_FILE_MB_XLSX", "60"))
UPLOAD_MAX_FILE_MB_XLSB = int(_get_env("UPLOAD_MAX_FILE_MB_XLSB", "60"))
UPLOAD_MAX_FILE_MB_XLS = int(_get_env("UPLOAD_MAX_FILE_MB_XLS", "60"))
...
UPLOAD_TABULAR_DEEP_INGEST_MAX_MB = int(_get_env("UPLOAD_TABULAR_DEEP_INGEST_MAX_MB", "8"))
UPLOAD_TABULAR_DEEP_INGEST_MAX_BYTES = UPLOAD_TABULAR_DEEP_INGEST_MAX_MB * 1024 * 1024
UPLOAD_TABULAR_DEEP_INGEST_MAX_ROWS = int(_get_env("UPLOAD_TABULAR_DEEP_INGEST_MAX_ROWS", "20000"))
UPLOAD_TABULAR_DEEP_INGEST_RECORD_LIMIT = int(_get_env("UPLOAD_TABULAR_DEEP_INGEST_RECORD_LIMIT", "5000"))
UPLOAD_JOB_STALE_SECONDS = int(_get_env("UPLOAD_JOB_STALE_SECONDS", "900"))
UPLOAD_MAX_BATCH_TOTAL_MB = int(_get_env("UPLOAD_MAX_BATCH_TOTAL_MB", "100"))
...
UPLOAD_TABULAR_ARTIFACT_BATCH_ROWS = int(_get_env("UPLOAD_TABULAR_ARTIFACT_BATCH_ROWS", "10000"))
UPLOAD_ARTIFACT_RETENTION_HOURS = int(_get_env("UPLOAD_ARTIFACT_RETENTION_HOURS", "72"))
UPLOAD_TABULAR_RAW_RETENTION_HOURS = int(_get_env("UPLOAD_TABULAR_RAW_RETENTION_HOURS", "24"))
